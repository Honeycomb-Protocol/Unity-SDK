...
namespace HplEdgeClient.Inputs
{
  ...
  public class CharacterConfigInput
  {
    ...
    public List<NftWrapCriteriaInput> Criterias { get; set; }
  ...
  public class NftWrapCriteriaInput
  {
    [JsonProperty("kind")]
    public string Kind { get; set; }
  ...
  public class CharacterSourceParamsFilter
  {
    ...
    public NftWrapCriteriaFilter Criteria { get; set; }
  ...
  public class NftWrapCriteriaFilter
  {
    [JsonProperty("kind")]
    public string Kind { get; set; }
  ...
  public class ServiceDelegationInput
  {
    ...
    [JsonProperty("CurrencyManager")]
    public List<ServiceDelegationCurrencyManager> CurrencyManager { get; set; }
  ...
  public class ServiceDelegationCurrencyManager
  {
    [JsonProperty("permission")]
    public CurrencyManagerPermissionInput Permission { get; set; }

    public ServiceDelegationCurrencyManager() { }
  ...
  public class ModifyServiceDelegationInput
  {
    ...
    [JsonProperty("CurrencyManager")]
    public ServiceDelegationCurrencyManager CurrencyManager { get; set; }
