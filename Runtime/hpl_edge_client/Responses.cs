...
namespace HplEdgeClient.Responses
{
  ...
  public class CreatePopulateAssembleablCharacterTransactionReturn
  {
    [JsonProperty("createPopulateAssembleablCharacterTransaction")]
    public Transaction CreatePopulateAssembleablCharacterTransaction { get; set; }

    public CreatePopulateAssembleablCharacterTransactionReturn() { }
