...
namespace HplEdgeClient.Client
{
    public class HplClient
    {
        ...
        {
            string query = @"query createAssembleCharacterTransaction(  $attributes: VecMapGeneric!  $project: String!  $assemblerConfig: String!  $characterModel: String!  $wallet: String!  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createAssembleCharacterTransaction(    attributes: $attributes    project: $project    assemblerConfig: $assemblerConfig    characterModel: $characterModel    wallet: $wallet    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
