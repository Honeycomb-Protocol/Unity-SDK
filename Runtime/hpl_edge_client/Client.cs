...
namespace HplEdgeClient.Client
{
    public class HplClient
    {
        ...
        {
            string query = @"query authConfirm($wallet: String!, $signature: String!) {  authConfirm(wallet: $wallet, signature: $signature) {    accessToken    user {      address      id      info {        bio        name        pfp        username      }      wallets {        shadow        wallets      }    }  }}";
        ...
        {
            string query = @"query findProfiles(  $addresses: [Bytes!]  $projects: [Pubkey!]  $userIds: [Int!]  $identities: [String!]  $includeProof: Boolean) {  profile(    addresses: $addresses    projects: $projects    userIds: $userIds    identities: $identities    includeProof: $includeProof  ) {    customData    address    identity    info {      bio      name      pfp    }    platformData {      achievements      custom      xp    }    project    userId    leaf_idx    tree_id    proof {      leaf      leaf_index      node_index      proof      maxDepth      root      tree_id      canopy_depth    }  }}";
        ...
        {
            string query = @"query createUpdateUserTransaction(  $info: PartialUserInfoInput  $wallets: UpdateWalletInput  $payer: String!  $populateCivic: Boolean  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createUpdateUserTransaction(    info: $info    wallets: $wallets    payer: $payer    populateCivic: $populateCivic    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
        ...
        {
            string query = @"query createNewUserWithProfileTransaction(  $project: String!  $wallet: String!  $payer: String  $userInfo: UserInfoInput  $profileIdentity: String  $profileInfo: ProfileInfoInput  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createNewUserWithProfileTransaction(    project: $project    wallet: $wallet    userInfo: $userInfo    profileIdentity: $profileIdentity    profileInfo: $profileInfo    payer: $payer    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
        ...
        {
            string query = @"query findAssemblerConfig(  $addresses: [Bytes!]  $tickers: [String!]  $characterModel: [Bytes!]  $project: [Pubkey!]) {  assemblerConfig(    addresses: $addresses    tickers: $tickers    characterModel: $characterModel    project: $project  ) {    address    program_id    discriminator    ticker    project    order    merkle_trees {      active      merkle_trees    }  }}";
        ...
        {
            string query = @"query findCharacterModels($addresses: [Bytes!], $project: Pubkey) {  characterModel(addresses: $addresses, project: $project) {    address    program_id    discriminator    bump    key    project    attributes    merkle_trees {      active      merkle_trees      schema    }    config {      ... on CharacterConfigWrapped {        criterias {          kind          params        }        kind      }      ... on CharacterConfigAssembled {        kind        assemblerConfig        name        symbol        description        creators {          address          share        }        sellerFeeBasisPoints        collectionName      }    }  }}";
        ...
        {
            string query = @"query findCharacters(  $includeProof: Boolean  $addresses: [Bytes!]  $filters: CharactersFilter  $trees: [Bytes!]  $wallets: [Pubkey!]  $mints: [Pubkey!]  $attributeHashes: [Pubkey!]) {  character(    includeProof: $includeProof    addresses: $addresses    filters: $filters    trees: $trees    wallets: $wallets    mints: $mints    attributeHashes: $attributeHashes  ) {    source {      kind      params {        ... on Wrapped {          mint          criteria {            kind            params          }          kind        }        ... on Assembled {          hash          mint          uri          attributes          updateAuthority        }      }      kind    }    owner    proof {      leaf      leaf_index      node_index      maxDepth      proof      root      tree_id      canopy_depth    }    usedBy {      kind      params {        ... on UsedByStaking {          pool          staker          stakedAt          claimedAt        }        ... on UsedByMission {          missionId          participationId          rewards {            delta            rewardIdx            collected          }          endTime        }        ... on UsedByGuild {          id          role {            kind          }          order        }        ... on UsedByEjected {          mint        }        ... on UsedByCustom {          user          data        }      }    }    leaf_idx    tree_id    address    asset  }}";
        ...
        {
            string query = @"query createCreateCharacterModelTransaction(  $config: CharacterConfigInput!  $project: String!  $authority: String!  $attributes: VecMapGeneric  $payer: String  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createCreateCharacterModelTransaction(    config: $config    project: $project    authority: $authority    attributes: $attributes    payer: $payer    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    characterModel    tx {      blockhash      lastValidBlockHeight      transaction    }  }}";
        ...
        {
            string query = @"query createAssembleCharacterTransaction(  $attributes: VecMapGeneric!  $project: String!  $assemblerConfig: String!  $characterModel: String!  $charactersTree: String!  $wallet: String!  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createAssembleCharacterTransaction(    attributes: $attributes    project: $project    assemblerConfig: $assemblerConfig    characterModel: $characterModel    charactersTree: $charactersTree    wallet: $wallet    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
        ...
        {
            string query = @"query createUpdateCharacterTraitsTransaction(  $characterAddress: String!  $attributes: VecMapGeneric!  $project: String!  $assemblerConfig: String!  $characterModel: String!  $charactersTree: String!  $wallet: String!  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createUpdateCharacterTraitsTransaction(    characterAddress: $characterAddress    attributes: $attributes    project: $project    assemblerConfig: $assemblerConfig    characterModel: $characterModel    charactersTree: $charactersTree    wallet: $wallet    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
        ...
        public async Task<CreatePopulateAssembleablCharacterTransactionReturn> CreatePopulateAssembleablCharacterTransaction(CreatePopulateAssembleablCharacterTransactionParams parameters, string authToken = null)
        {
            string query = @"query createPopulateAssembleablCharacterTransaction(  $attributes: VecMapGeneric!  $project: String!  $characterModel: String!  $charactersTree: String!  $mint: String!  $owner: String!  $updateAuthority: String!  $payer: String  $lutAddresses: [String!]  $computeUnitPrice: Int) {  createPopulateAssembleablCharacterTransaction(    attributes: $attributes    project: $project    characterModel: $characterModel    charactersTree: $charactersTree    mint: $mint    owner: $owner    updateAuthority: $updateAuthority    payer: $payer    lutAddresses: $lutAddresses    computeUnitPrice: $computeUnitPrice  ) {    blockhash    lastValidBlockHeight    transaction  }}";
            var response = await graphQLClient.Query<CreatePopulateAssembleablCharacterTransactionReturn, CreatePopulateAssembleablCharacterTransactionParams>(query, parameters, authToken);
            return response.GetData();
        }
        ...
        {
            string query = @"query findResources(  $addresses: [Bytes!]  $projects: [Pubkey!]  $mints: [Pubkey!]) {  resources(projects: $projects, mints: $mints, addresses: $addresses) {    storage {      params {        merkle_trees {          schema          merkle_trees          active        }      }      kind    }    project    mint    kind {      kind      params {        ... on ResourceKindParamsHplFungible {          __typename          decimals        }        ... on ResourceKindParamsWrappedFungible {          __typename          decimals        }        ... on ResourceKindParamsHplNonFungible {          __typename          characteristics        }        ... on ResourceKindParamsWrappedMplCore {          __typename          characteristics        }      }    }    bump    address  }}";
        ...
        {
            string query = @"query findHoldings(  $addresses: [Bytes!]  $holder: Pubkey  $trees: [Bytes!]  $includeProof: Boolean) {  holdings(    addresses: $addresses    holder: $holder    trees: $trees    includeProof: $includeProof  ) {    address    balance    characteristics    holder    leaf_idx    tree_id    proof {      canopy_depth      leaf      leaf_index      maxDepth      node_index      proof      root      tree_id    }  }}";
