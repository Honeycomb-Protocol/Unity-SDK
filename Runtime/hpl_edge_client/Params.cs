...
namespace HplEdgeClient.Params
{
  ...
  public class CreateNewUserWithProfileTransactionParams
  {
    ...
    public ProfileInfoInput ProfileInfo { get; set; }
  ...
  public class CreateAssembleCharacterTransactionParams
  {
    ...
    [JsonProperty("charactersTree")]
    public string CharactersTree { get; set; }
  ...
  public class CreatePopulateAssembleablCharacterTransactionParams
  {
    [JsonProperty("attributes")]
    public object Attributes { get; set; }
    ...
    public CreatePopulateAssembleablCharacterTransactionParams() { }
